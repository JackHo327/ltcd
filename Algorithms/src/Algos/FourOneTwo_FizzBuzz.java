...
/**
 * @author Renzhi He Write a program that outputs the string representation of
 *         numbers from 1 to n. But for multiples of three it should output
 *         鈥淔izz鈥� instead of the number and for the multiples of five output
 *         鈥淏uzz鈥�. * For numbers which are multiples of both three and five
 *         output 鈥淔izzBuzz鈥�.
 */
