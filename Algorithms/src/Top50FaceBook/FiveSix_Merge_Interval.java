...
class FiveSix_Merge_Interval {
      public List<Interval> merge(List<Interval> intervals) {
            ...
            // }
            // }
            // Interval tmpInterval = new Interval(intervals.get(min).start,intervals.get(min).end);
            ...
            // sort the sub intervals without lamda -- quickSort(List<Interval> intervals, int start, int end)
